...
class BrowserHeroWrapper extends StatefulWidget {
  const BrowserHeroWrapper({
    required this.child,
    required this.tag,
  ...
  @override
  BrowserHeroWrapperState createState() => BrowserHeroWrapperState();
}

class BrowserHeroWrapperState extends State<BrowserHeroWrapper> {
      ...
      flightShuttleBuilder: (
        ...
        if (flightDirection == HeroFlightDirection.pop) {
          final bool fixTransform = widget.slideType == SlideType.onlyImage &&
              (widget.slidePagekey.currentState != null &&
            ...
            builder: (BuildContext buildContext, Widget? child) {
              ...
              animatedBuilderChild = Stack(
                ...
                children: <Widget>[
                  ...
                  Opacity(
                    opacity: max(0.0, animation.value),
