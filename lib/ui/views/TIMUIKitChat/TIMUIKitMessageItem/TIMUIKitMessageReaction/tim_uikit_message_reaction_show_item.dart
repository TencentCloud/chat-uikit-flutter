...
class TIMUIKitMessageReactionShowItem extends TIMUIKitStatelessWidget {
  ...
  static Future<String> _getGroupMemberShowName(
    ...
    try {
      ...
      debugPrint('_getGroupMemberShowName error: $e');
      return '';
    }
  }
  ////////////////// 加载点击 sticker 的成员信息 //////////////////
                  ...
                  overflowWidget: GestureDetector(
                    ...
                    child: Text(
                      TIM_t_para("...共{{option1}}人", "...共$option1人")(
                          option1: option1),
                      style:
                          TextStyle(fontSize: 12, color: hexToColor("616669")),
                    ),
                  ),
                  children: [
                    ...nameList.map(
                      (e) {
                        ...
                        return InkWell(
                          ...
                          child: message.groupID?.isNotEmpty == true
                              ? FutureBuilder(
                                  future: _getGroupMemberShowName(
                                      message.groupID ?? '', e ?? ''),
