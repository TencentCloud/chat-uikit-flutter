...
class TencentCloudChatDragArea extends StatefulWidget {
  final Widget child;
  ...
  const TencentCloudChatDragArea(
      {Key? key,
      required this.child,
      this.initOffset,
      this.closeFun,
...
class _DragAreaStateStateful extends State<TencentCloudChatDragArea> {
