  ...
  showModalBottomSheet<void>(
    ...
    builder: (BuildContext _) {
      return TencentCloudChatGroupMemberSelector(
        groupMemberList: includeSelf ? groupMemberList : groupMemberList.where((element) => element.userID != (TencentCloudChat.instance.dataInstance.basic.currentUser?.userID ?? "")).toList(),
