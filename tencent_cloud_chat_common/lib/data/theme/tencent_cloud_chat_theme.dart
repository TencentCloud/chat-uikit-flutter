...
class TencentCloudChatTheme {
  ...
  factory TencentCloudChatTheme({TencentCloudChatThemeModel? themeMode, Brightness? brightness}) {
  ...
  static init({Brightness? brightness, TencentCloudChatThemeModel? themeModel}) {
    if (brightness != null) {
  ...
  void setThemeColors({required Brightness brightness, required TencentCloudChatThemeColors themeColors}) {
