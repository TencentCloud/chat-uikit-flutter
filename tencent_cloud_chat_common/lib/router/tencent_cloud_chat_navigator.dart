...
/// Navigate to `TencentCloudChatGroupMemberInfo`, while options should be `TencentCloudChatGroupMemberInfoOptions`
Future<T?>? navigateToGroupMemberInfo<T extends Object?>({
  required BuildContext context,
  dynamic options,
}) {
  return TencentCloudChatRouter().navigateTo<T>(
...
/// Navigate to `TencentCloudChatGroupAddMember`, while options should be `TencentCloudChatGroupAddMemberOptions`
Future<T?>? navigateToAddGroupMember<T extends Object?>({
  required BuildContext context,
  dynamic options,
}) {
  return TencentCloudChatRouter().navigateTo<T>(
...
Future<T?>? navigateToStartGroupChat<T extends Object?>({
  required BuildContext context,
  dynamic options,
}) {
  return TencentCloudChatRouter().navigateTo<T>(
...
Future<T?>? navigateToStartC2CChat<T extends Object?>({
  required BuildContext context,
  dynamic options,
}) {
  return TencentCloudChatRouter().navigateTo<T>(
