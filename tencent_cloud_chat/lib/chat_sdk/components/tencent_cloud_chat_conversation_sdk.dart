...
class TencentCloudChatConversationSDK {
  ...
  static final V2TimConversationListener conversationListener =
  ...
  static pinConversation({
    ...
    V2TimCallback pinRes = await TencentCloudChatSDK.manager
  ...
  static Future<V2TimConversation> getConversation(
    ...
    if (TencentCloudChatUtils.checkString(userID) != null) {
      ...
      final userProfileRes = await TencentCloudChatSDK.manager
      ...
      final groupInfoRes = await TencentCloudChatSDK.manager
          .getGroupManager()
  ...
  static Future<void> getConversationList({
    ...
    String paramSeq =
        seq ?? TencentCloudChatConversationData.currentGetConversationListSeq;
    int paramCount =
        count ?? TencentCloudChatConversationData.getConversationListCount;
    ...
    if (conListRes.code == 0) {
      if (conListRes.data != null) {
        if (conListRes.data!.isFinished != null) {
          ...
          TencentCloudChatConversationData.isGetConversationFinished =
        ...
        if (conListRes.data!.conversationList != null) {
          if (conListRes.data!.conversationList!.isNotEmpty) {
            ...
            TencentCloudChat.dataInstance.conversation.conversationList =
                conListFormat;
            TencentCloudChat.dataInstance.conversation
                .buildConversationList(conListFormat, 'getConversationList');
          }
        }
      }
  ...
  static _getOtherConversation() async {
    console(
        "Get complete conversationList asynchronously ${TencentCloudChatConversationData.isGetConversationFinished}");
  ...
  static getTotalUnreadCount() async {
    V2TimValueCallback<int> totalRes = await TencentCloudChatSDK.manager
        .getConversationManager()
